  ...
  if (isSignedUp) {
    return (
      <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
        ...
        >
          <div className="w-16 h-16 bg-zinc-100 text-zinc-900 rounded-full flex items-center justify-center mx-auto">
            <Mail size={32} />
          </div>
    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col gap-2 text-center">
          ...
          <p className="text-zinc-500">Start sharing your world today.</p>
        </div>
